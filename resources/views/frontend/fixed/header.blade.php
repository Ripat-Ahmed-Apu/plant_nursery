                ...
                <div class="col-md-4 col-sm-2">
                    ...
                    <div  class="logo" style="padding: 0!important">
                        ...
                        <img src="{{url('img/nlogo.png')}}" style="width: 80px; height: 80px">
                            ...
                            <a style="text-align: center;color: white;font-weight: bolder;"> Plant paradise </a>
                        </a>
                ...
                <div  class="right col-md-6" style="padding: 0!important">
                        ...
                        <div  class="search-form" style="padding: 0!important">
                                ...
                                <form  action="{{route('search')}}" class="navbar-form" role="search">
                                    ...
                                    <input  style="border-color: green; " name="search" type="text" class="form-control" placeholder="Search...">

                                    </div>

                                    <button style="background-color: green;" type="submit" class="btn"><i class="fa fa-search"></i></button>
...
<div class="col-md-2"><a style="color:white"  href="{{route('cart.view')}}"><i class="fa fa-shopping-cart"> CART</i></a>
    <br>
    <a style="text-align: center;color:white  "> {{session()->has('cart')?count(session()->get('cart')):0}} <br> items  </br> </a> </div>
                <!-- <div class="col-md-2 col-sm-3">
       ...
       <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar">
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                @if (auth('customer')->guest())
                <li><a style="background-color: green;" href="{{route('customer.registration')}}"><i class="fa fa-user"></i> Register</a></li>
                <li><a style="background-color: green;" href="{{route('customer.login')}}"><i class="fa fa-key"></i> Login</a></li>
                @endif
